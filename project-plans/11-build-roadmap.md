...
- **Status in `eak/`:** ◐ **inc 1 built** — `PowerDomain` object + seam + `erc-power-balance` rule
  ([ADR-0022](../docs/decisions/0022-band-b-power-domain.md)); remaining objects one per increment.
...
| 5 Band B — logical-electrical | L5 | ◐ **inc 1 built** (`PowerDomain` rail + `erc-power-balance`; 295 tests; ADR-0022) |
