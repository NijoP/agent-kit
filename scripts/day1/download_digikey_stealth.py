#!/usr/bin/env python3
"""
Use Playwright with stealth to bypass Cloudflare and download datasheets from DigiKey.
"""
...
async def download_from_digikey(page, mpn, output_path):
    """Try to download datasheet from DigiKey using stealth."""
    ...
    try:
        ...
        # Look for datasheet link - try multiple selectors
        selectors = [
            'a[href*="datasheet"]',
            'a[href$=".pdf"]',
